...
else
{
	...
	for ($i=1;$i<=$nb_decoupes_intervalle;$i++)
	{
		...
		echo 'Intervalle #'.$i.' ['.$borne_inf.' ; '.$borne_sup.'] : <span class="green">'.$densite[$i].'</span> éléments (valeur théorique : '.$valeur_theorique.', écart de <b>'.$pourcentage_ecart.' %</b>)<br/>';
	}
	echo '</div>';
