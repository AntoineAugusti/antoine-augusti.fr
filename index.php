	...
	<div class="corps-right">
		...
		<div class="gray-post">
			<ul class="inside-square">
				<?php
				$reponse = mysql_query("SELECT guid, post_title, post_date FROM wp_posts WHERE post_status = 'publish' AND post_type = 'post' ORDER BY post_date DESC LIMIT 0,5");
